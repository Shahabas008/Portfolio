...
const MainHeroComponent = () => {
  ...
  return (
    <div className="h-auto">
      ...
      <div className="px-[15%] text-center leading-[120%] flex items-center justify-center w-full font-[cabinetExtrabold] text-[32px] lg:text-[48px] text-Black">
        Develop robust solutions with software development professionals.
      </div>

      <div className="flex items-center justify-center text-center w-full font-[GilroySemiBold] text-[16px] text-TertiaryColor">
      ...
      <div className="grid lg:grid-cols-4 ">
        ...
        <div className="col-span-3">
          ...
          <div className="flex items-start justify-center lg:justify-start">
            ...
            <div className="mt-[40px] bg-PrimaryColor w-auto lg:w-[25%] text-center px-4 py-4 rounded-[50px] font-[GilroySemiBold] text-[20px] text-SecondaryColor cursor-pointer hover:-translate-y-2 duration-500 hover:shadow-lg">
              Start a chat now
            </div>
          </div>

          {/* Introduction */}
          <div className="text-[20px] leading-[25px] px-[5%] lg:px-[0] xl:pl-[5%] mt-[10%] lg:mt-[0] text-center lg:text-left lg:pr-[10%] text-Black font-[GilroyMedium] lg:ml-[12%] xl:ml-[0%]">
          ...
          {/* social Media icons */}
          <div className=" flex items-center justify-center lg:justify-start mt-[8%] xl:pl-[5%] lg:ml-[12%] xl:ml-[0%]">
          ...
          <div className="px-[3%] lg:px-[0] grid grid-cols-6 mt-[5%] lg:mt-[2%] lg:ml-[12%] xl:pl-[5%] xl:ml-[0%]">
            <div className="col-span-5 lg:flex-none flex justify-center lg:justify-start lg:col-span-0 text-[16px] text-center lg:text-left font-[GilroyMedium] text-Black leading-[20px] ">
            ...
            <div className="flex justify-end mr-[5%]">
              <img src={AsteroidIcons} width={"20%"} alt="icon" />
            </div>
          </div>

          {/* Partner Logo */}
          <div className="flex items-center lg:justify-normal justify-center lg:ml-[5%] mt-[100px] lg:mt-[136px]">
